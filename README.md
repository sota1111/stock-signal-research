...
| 大口投資家 / 13F | SEC EDGAR Form 13F-HR | 主要機関投資家 100 社（Vanguard, BlackRock, State Street, Geode, FMR, JPMorgan, Goldman Sachs, Morgan Stanley, Norges Bank, CalPERS, Bridgewater, Tiger Global ほか）× 半導体関連銘柄 / 過去約10年・年次 | `backend/data/collected-investors.json` | `collect_investor_data.py` |
